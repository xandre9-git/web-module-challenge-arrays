...
let testFunc = ["practice", "makes", "perfect"]    
...
console.log(is31Flavors(testFunc))
...
function removeLastFlavor(arr){
    arr.pop(); // .pop() method removes the last element from the array and returns that element.
    console.log(originalFlavors)
}
...
*/
// the splice() method changes the contents of an array by removing or replacing exising elements and/or adding new elements in place
